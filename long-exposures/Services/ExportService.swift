...
struct ExportService {
    ...
    func renderFullResolution(frames: [CVPixelBuffer], range: ClosedRange<Int>, mode: BlendMode,
        ...
        let cgImage = try engine.blend(frames: Array(frames[lower...upper]), mode: mode)
